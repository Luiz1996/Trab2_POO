 ...
 * @author Vini
 */
public class AltProntuarioView extends javax.swing.JFrame {

    /**
     * Creates new form AltProntuarioView
     */
    public AltProntuarioView() {
        setTitle("Alterar Prontuário | Saúde & Cia");
        setIcon();
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltProntuarioView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltProntuarioView().setVisible(true);
            }
        });
    }
