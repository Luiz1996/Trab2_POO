 ...
 * @author Vini
 */
public class DelProntuarioView extends javax.swing.JFrame {

    /**
     * Creates new form DelProntuarioView
     */
    public DelProntuarioView() {
        setTitle("Deletar Prontuário | Saúde & Cia");
        setIcon();
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelProntuarioView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DelProntuarioView().setVisible(true);
            }
        });
    }
