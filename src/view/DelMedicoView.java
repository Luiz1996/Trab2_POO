 ...
 * @author Luiz Flávio
 */
public class DelMedicoView extends javax.swing.JFrame {

    /**
     * Creates new form DelMedicoView
     */
    public DelMedicoView() {
        setTitle("Deletar Médico | Saúde & Cia");
        setIcon();
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelMedicoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DelMedicoView().setVisible(true);
            }
        });
    }
