 ...
 * @author Luiz Flávio
 */
public class ConsMedicoView extends javax.swing.JFrame {

    /**
     * Creates new form ConsMedicoView
     */
    public ConsMedicoView() {
        setTitle("Consultar Médico | Saúde & Cia");
        setIcon();
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsMedicoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsMedicoView().setVisible(true);
            }
        });
    }
